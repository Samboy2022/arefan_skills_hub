...
export const MOCK_ASSIGNMENTS: Assignment[] = [
  ...
  },
  {
    id: "assign-6",
    courseId: "course-1",
    title: "Algorithm Analysis Draft",
    description: "Draft assignment on Big-O notation and time complexity analysis",
    type: "essay",
  ...
  },
  {
    ...
    description: "Online quiz covering React hooks, props, and state management",
    type: "online",
  ...
  },
  {
    ...
    description: "Implement and compare merge sort, quick sort, and heap sort",
    type: "file",
    ...
    submissions: [
      {
        ...
        studentId: "student-1",
        submissionDate: new Date("2024-02-19"),
        score: 92,
        feedback: "Excellent comparison and benchmarks.",
        status: "graded",
        files: ["sorting_algorithms.cpp"],
      },
      {
        id: "sub-9",
        assignmentId: "assign-8",
        ...
        score: 85,
        feedback: "Good work on the complexity analysis.",
        status: "graded",
      },
      {
        id: "sub-10",
  ...
  },
  {
    ...
    description: "Participate in a forum discussion on REST vs GraphQL API design patterns",
    type: "discussion",
    ...
    submissions: [
      {
        ...
        score: 28,
        feedback: "Great insights on GraphQL trade-offs.",
        status: "graded",
      },
    ],
    createdAt: new Date("2024-02-01"),
