      ...
      <div className="flex items-center justify-between border-b border-border px-4 py-4">
        {expanded && (
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="text-sm font-semibold text-foreground">Student</h2>
              ...
              {section.items.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {!expanded && (
                      <div className="absolute left-20 hidden rounded-lg bg-popover px-2 py-1 text-xs text-popover-foreground shadow-md group-hover:block whitespace-nowrap">
                        {item.tooltip}
                      </div>
                    )}
                  </Link>
