        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex gap-4">
              <a href="https://twitter.com/fnskills" target="_blank" rel="noopener noreferrer" aria-label="Follow FnSkills on X (Twitter)" className="h-8 w-8 rounded-full bg-slate-800 flex items-center justify-center hover:bg-primary transition-colors">
