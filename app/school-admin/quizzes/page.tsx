  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div>
        <PageHeader
          title="Quizzes & Exams"
          description="Create and manage assessments for your students."
          titleAction={
            ...
            {quizzes.length === 0 ? (
              ...
              <TableRow key={quiz.id}>
                <TableCell className="font-medium text-foreground">
                  {quiz.title}
                  <Link href={`/school-admin/quizzes/${quiz.id}/questions`} className="block mt-1 text-[10px] text-primary hover:underline font-normal uppercase tracking-wider">
                    Build Questions
                  </Link>
                </TableCell>
