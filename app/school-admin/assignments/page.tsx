                ...
                <TableRow key={assignment.id} className="hover:bg-muted/30 transition-colors">
                  ...
                  <TableCell className="text-right">
                    <div className="flex items-center justify-end gap-1">
                      <Button variant="ghost" size="icon" asChild className="h-8 w-8 hover:bg-blue-100 hover:text-blue-700 dark:hover:bg-blue-900/50 dark:hover:text-blue-300">
                        <Link href={`/school-admin/assignments/${assignment.id}/submissions`}>
                          <Eye className="h-4 w-4" />
                        </Link>
                      </Button>
                      <Button variant="ghost" size="icon" asChild className="h-8 w-8 hover:bg-muted">
                        <Link href={`/school-admin/assignments/edit/${assignment.id}`}>
