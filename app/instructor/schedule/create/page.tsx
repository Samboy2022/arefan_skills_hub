...
export default function CreateEventPage() {
  ...
  const handleCreate = (e: React.FormEvent) => {
    ...
    // Simulate API delay
    setTimeout(() => {
        try { toast.success("Event successfully created!"); } catch(e) {}
        ...
        <div className="p-6 md:p-8 border-b bg-gradient-to-b from-background to-muted/10">
          <div className="flex items-center gap-4">
            <div className="h-12 w-12 rounded-xl bg-blue-100 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 flex items-center justify-center shrink-0 shadow-sm">
                <img src="https://img.icons8.com/color/96/planner.png" alt="Create Event" className="h-7 w-7 filter drop-shadow-sm" />
            </div>
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-foreground tracking-tight leading-tight">Create a New Event</h1>
              <p className="text-muted-foreground mt-1 text-sm">Schedule a class, meeting, deadline, or personal block.</p>
            </div>
          </div>
        </div>
